...
Figures ~\ref{fig:mpicreate} to ~\ref{fig:jsmol} shows some of the screenshots that achieve the use case (Figure ~\ref{fig:usecase}) for SkyLab.
...
\begin{figure}			
	...
	\caption{\label{fig:jsmol}Task detail view. The user can view results of tasks. JSmol \cite{IJCH:IJCH201300024} renders the compatible output files from a GAMESS task.}			
\end{figure}	
