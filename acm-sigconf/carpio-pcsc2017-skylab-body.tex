...
Access to SkyLab is restricted to individuals with @up.edu.ph email only using django-allauth\footnote{http://www.intenct.nl/projects/django-allauth/}. Tables used with socialaccount\_ prefix as shown in Figure ~\ref{fig:dbschema} are used for authentication.
