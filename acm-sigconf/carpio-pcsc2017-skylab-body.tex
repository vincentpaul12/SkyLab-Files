...
\section{Results and Discussion}
			...
			\begin{figure}			
				...
				\captionof{figure}{MPI creation form.The user can create an MPI cluster with optional tool activations.}			
			\end{figure}	
	
		\begin{figure}			
			%\includegraphics[scale=0.33]{./images/mpi_list_view.png}
			\includegraphics{./images/n_active_cluster_printed.png}
			\captionof{figure}{MPI cluster table.The user can monitor visible public and private MPI clusters.}		
		\end{figure}
		
	
		\begin{figure}			
			\includegraphics[scale=0.50]{./images/add_private_cluster_2.png}		
			\captionof{figure}{Add private cluster form.The user can make a private cluster visible by entering a valid share key.}			
		\end{figure}	
		
		\begin{figure}			
			%\includegraphics[scale=0.40]{./images/mpi_detail_view_2.png}			
			\includegraphics{./images/n_new_cluster_created_printed}
			\captionof{figure}{MPI detail view.The user can view details about a MPI cluster. If the user is the cluster's owner he has the option to delete the cluster.}			
		\end{figure}	
		
		\begin{figure}			
			%\includegraphics[scale=0.45]{./images/toolset_list_2.png}			
			\includegraphics[scale=0.93]{./images/n_toolsets_printed.png}			
			\captionof{figure}{Toolset list view.The user can select from a list which tool does he want to use.}			
		\end{figure}
		
		\begin{figure}			
			%\includegraphics[scale=0.40]{./images/gamess_form_2.png}			
			\includegraphics[scale=0.93]{./images/n_impi_parameters_printed.png}
			\captionof{figure}{GAMESS task creation form.The user can submit a task by filling up a tool's task creation form.}			
		\end{figure}	
		
		\begin{figure}			
			%\includegraphics[scale=0.40]{./images/tasks_list_view_2.png}			
			\includegraphics[scale=0.93]{./images/n_tasks_printed.png}			
			\captionof{figure}{Task table view.The user can monitor created tasks.}			
		\end{figure}	

		\begin{figure}			
			\includegraphics[scale=0.35]{./images/jsmol_detail_view_2.png}			
			\captionof{figure}{Task detail view.he user can view results of tasks. JSmol renders the compatible output files\cite{IJCH:IJCH201300024}}			
		\end{figure}	
...
This work is supported by the Philippine Department of Science and Technology Accelerated Science and Technology Human Resource Development Program. We also would like to thank our collaborators from the Physics Department and Institute of Chemistry especially Dr. Abraham Padama and Dr. Marlon Manalo.
%Many thanks to...
% BIBLIOGRAPHY
% \nocite{*}
