...
\begin{figure}			
	...
	\captionof{figure}{MPI cluster creation. A cluster name cmsc165\_image\_processing is being created with Impi tool being activated.}			
\end{figure}	
...
\begin{figure}			
	...
	\captionof{figure}{MPI cluster details view. The detailed view of the cmsc165\_image\_processing MPI cluster with a list of toolsets that can be activated.}			
\end{figure}	
...
\begin{figure}			
	...
	\captionof{figure}{Task detail view. The user can view results of tasks. JSmol renders the compatible output files\cite{IJCH:IJCH201300024} from a GAMESS task.}			
\end{figure}	
