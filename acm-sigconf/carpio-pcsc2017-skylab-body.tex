...
The use case on which SkyLab was designed is shown in Figure ~\ref{fig:usecase}
	...
	\begin{itemize}
		...
		\item The user can create an MPI cluster with optional tool activations. 
			\begin{center}			
				...
				\includegraphics{./images/n_create_cluster_impi_printed.png}
		...
		\begin{center}			
			...
			\includegraphics{./images/n_toolsets_printed.png}			
		...
		\begin{center}			
			...
			\includegraphics{./images/n_impi_parameters_printed.png}
		...
		\begin{center}			
			...
			\includegraphics{./images/n_tasks_printed.png}			
