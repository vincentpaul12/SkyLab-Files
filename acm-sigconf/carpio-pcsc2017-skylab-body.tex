...
All tools must inherit from \textit{P2CToolGeneric}(see basetool.py) and override the methods to handle tool specific operations. The following are the methods. Listing 1 shows an example implementation.
